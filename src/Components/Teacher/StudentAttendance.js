        ...
        <div>
            <div class={`d-flex ${isToggled ? 'toggled' : ''}`} id="wrapper">
                ...
                <div class="bg-white" id="sidebar-wrapper">
                    <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><FontAwesomeIcon icon={faUserSecret} className='me-2' />AMS Panel</div>
                                    ...
                                    <div class="row my-5">
                                        ...
                                        <div className='mb-1 w-100 d-flex justify-content-between'>
                                            ...
                                            <div className='d-flex'>
                                                <div className=''>
                                                    {/* <label className='mx-1 fw-bold'>Select date</label> */}
